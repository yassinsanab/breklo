...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/organize-pdf',
    languages: {
      en: 'https://www.breklo.com/organize-pdf',
      de: 'https://www.breklo.com/de/organize-pdf',
      'x-default': 'https://www.breklo.com/organize-pdf',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/organize-pdf',
    locale: 'de_DE',
  },
};
