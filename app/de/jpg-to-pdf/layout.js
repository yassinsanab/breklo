...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/jpg-to-pdf',
    languages: {
      en: 'https://www.breklo.com/jpg-to-pdf',
      de: 'https://www.breklo.com/de/jpg-to-pdf',
      'x-default': 'https://www.breklo.com/jpg-to-pdf',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/jpg-to-pdf',
    locale: 'de_DE',
  },
};
