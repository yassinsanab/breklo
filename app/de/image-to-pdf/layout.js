...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/image-to-pdf',
    languages: {
      en: 'https://www.breklo.com/image-to-pdf',
      de: 'https://www.breklo.com/de/image-to-pdf',
      'x-default': 'https://www.breklo.com/image-to-pdf',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/image-to-pdf',
    locale: 'de_DE',
  },
};
