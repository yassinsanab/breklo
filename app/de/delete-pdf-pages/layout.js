...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/delete-pdf-pages',
    languages: {
      en: 'https://www.breklo.com/delete-pdf-pages',
      de: 'https://www.breklo.com/de/delete-pdf-pages',
      'x-default': 'https://www.breklo.com/delete-pdf-pages',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/delete-pdf-pages',
    locale: 'de_DE',
  },
};
