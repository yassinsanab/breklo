...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/gif-to-jpg',
    languages: {
      en: 'https://www.breklo.com/gif-to-jpg',
      de: 'https://www.breklo.com/de/gif-to-jpg',
      'x-default': 'https://www.breklo.com/gif-to-jpg',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/gif-to-jpg',
    locale: 'de_DE',
  },
};
