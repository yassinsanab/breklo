...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/split-pdf',
    languages: {
      en: 'https://www.breklo.com/split-pdf',
      de: 'https://www.breklo.com/de/split-pdf',
      'x-default': 'https://www.breklo.com/split-pdf',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/split-pdf',
    locale: 'de_DE',
  },
};
