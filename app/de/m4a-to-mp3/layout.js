...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.breklo.com/de/m4a-to-mp3',
    languages: {
      en: 'https://www.breklo.com/m4a-to-mp3',
      de: 'https://www.breklo.com/de/m4a-to-mp3',
      'x-default': 'https://www.breklo.com/m4a-to-mp3',
    },
  },
  openGraph: {
    title: (content.h1 || meta.title || 'Breklo'),
    description: (content.intro || meta.subtitle || '').slice(0, 160),
    url: 'https://www.breklo.com/de/m4a-to-mp3',
    locale: 'de_DE',
  },
};
