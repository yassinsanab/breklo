...
const categories = [
  ...
  { id:'from', label:'Convert from PDF', tools:[
    { name:'PDF to JPG',   abbr:'JPG', live:false, slug:null },
    { name:'PDF to PNG',   abbr:'PNG', live:false, slug:null },
    { name:'PDF to Text',  abbr:'TXT', live:false, slug:null },
  ...
  { id:'to', label:'Convert to PDF', tools:[
    { name:'JPG to PDF',   abbr:'PDF', live:false, slug:null },
    { name:'PNG to PDF',   abbr:'PDF', live:false, slug:null },
    { name:'Image to PDF', abbr:'PDF', live:false, slug:null },
  ...
  { id:'image', label:'Image Tools', tools:[
    { name:'Compress Image',     abbr:'IMG', live:false, slug:null },
    { name:'HEIC to JPG',        abbr:'HIC', live:false, slug:null },
    { name:'JPG to PNG',         abbr:'PNG', live:false, slug:null },
    { name:'PNG to JPG',         abbr:'JPG', live:false, slug:null },
    { name:'JPG to WebP',        abbr:'WBP', live:false, slug:null },
    { name:'GIF to JPG',         abbr:'GIF', live:false, slug:null },
    { name:'Merge Images',       abbr:'MRG', live:false, slug:null },
    { name:'SVG to JPG',         abbr:'SVG', live:false, slug:null },
